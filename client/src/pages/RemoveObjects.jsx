     ...
     text-slate-700'>
        ...
        <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4
         bg-white rounded-lg border
          ...
          value={object} rows={4} className='w-full p-2 px-3 
          mt-2 outline-none text-sm rounded-md border
           border-gray-300' 
           placeholder='Describe only a single object to remove'
            required/>

          <button disabled={loading} className=' w-full flex justify-center 
          items-center gap-2 bg-gradient-to-r
           from-[#417DF6] to-[#427DF5]
